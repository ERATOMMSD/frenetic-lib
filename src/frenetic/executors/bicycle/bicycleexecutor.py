...
class BicycleExecutor(AbstractExecutor):
    ...
    def _execute(self, test: list) -> dict:
        ...
        # simulate
        data = cpb.execute_carla_pid_on_bicycle(*interpolated_line.xy,
        ...
        records_df["distance_from_center"] = records_df.points.apply(lambda p: geometry.LineString(ops.nearest_points(interpolated_line, p)).length)
